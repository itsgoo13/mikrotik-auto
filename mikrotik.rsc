...
:if ([/queue simple find name="cust_ALFA"] = "") do={
  /queue simple add name="cust_ALFA" target=30.30.30.110 max-limit=1M/512k
} else={
  /queue simple set [find name="cust_ALFA"] target=30.30.30.110 max-limit=1M/512k
}
...
:if ([/queue simple find name="cust_ARIF_DARMI"] = "") do={
...
:if ([/queue simple find name="cust_CENAY_"] = "") do={
  /queue simple add name="cust_CENAY_" target=30.30.30.112 max-limit=3M/3M
} else={
...
:if ([/queue simple find name="cust_FAJAR_"] = "") do={
  /queue simple add name="cust_FAJAR_" target=30.30.30.111 max-limit=1M/512k
} else={
  /queue simple set [find name="cust_FAJAR_"] target=30.30.30.111 max-limit=1M/512k
}
...
:if ([/queue simple find name="cust_JABLAY"] = "") do={
  /queue simple add name="cust_JABLAY" target=30.30.30.120 max-limit=1M/512k
} else={
  /queue simple set [find name="cust_JABLAY"] target=30.30.30.120 max-limit=1M/512k
}
:if ([/queue simple find name="cust_JIMI"] = "") do={
  /queue simple add name="cust_JIMI" target=30.30.30.107 max-limit=1M/512k
} else={
  /queue simple set [find name="cust_JIMI"] target=30.30.30.107 max-limit=1M/512k
}
...
:if ([/queue simple find name="cust_KA_MIDAH"] = "") do={
  ...
  /queue simple set [find name="cust_KA_MIDAH"] target=30.30.30.101 max-limit=10M/10M
}
:if ([/queue simple find name="cust_KA_NUR_ECE"] = "") do={
  /queue simple add name="cust_KA_NUR_ECE" target=30.30.30.139 max-limit=3M/3M
} else={
  /queue simple set [find name="cust_KA_NUR_ECE"] target=30.30.30.139 max-limit=3M/3M
}
:if ([/queue simple find name="cust_KAMPLENG"] = "") do={
  /queue simple add name="cust_KAMPLENG" target=30.30.30.180 max-limit=1M/512k
} else={
  /queue simple set [find name="cust_KAMPLENG"] target=30.30.30.180 max-limit=1M/512k
}
:if ([/queue simple find name="cust_KONTR_ACUY"] = "") do={
...
:if ([/queue simple find name="cust_MAMA_RIZKI"] = "") do={
  ...
  /queue simple set [find name="cust_MAMA_RIZKI"] target=30.30.30.222 max-limit=1M/512k
}
:if ([/queue simple find name="cust_MANG_ALI"] = "") do={
  /queue simple add name="cust_MANG_ALI" target=30.30.30.10 max-limit=8M/8M
} else={
  /queue simple set [find name="cust_MANG_ALI"] target=30.30.30.10 max-limit=8M/8M
}
:if ([/queue simple find name="cust_MANG_RONI"] = "") do={
  /queue simple add name="cust_MANG_RONI" target=30.30.30.104 max-limit=1M/512k
} else={
  /queue simple set [find name="cust_MANG_RONI"] target=30.30.30.104 max-limit=1M/512k
}
:if ([/queue simple find name="cust_MANG_SURI"] = "") do={
  /queue simple add name="cust_MANG_SURI" target=30.30.30.191 max-limit=1M/512k
} else={
  /queue simple set [find name="cust_MANG_SURI"] target=30.30.30.191 max-limit=1M/512k
}
...
:if ([/queue simple find name="cust_POS/SUKIR"] = "") do={
  /queue simple add name="cust_POS/SUKIR" target=30.30.30.252 max-limit=1M/512k
} else={
  /queue simple set [find name="cust_POS/SUKIR"] target=30.30.30.252 max-limit=1M/512k
}
:if ([/queue simple find name="cust_RABBEL"] = "") do={
  /queue simple add name="cust_RABBEL" target=30.30.30.151 max-limit=1M/512k
} else={
  /queue simple set [find name="cust_RABBEL"] target=30.30.30.151 max-limit=1M/512k
}
...
:if ([/queue simple find name="cust_TELE"] = "") do={
  /queue simple add name="cust_TELE" target=30.30.30.211 max-limit=1M/512k
} else={
  /queue simple set [find name="cust_TELE"] target=30.30.30.211 max-limit=1M/512k
}
